"""
This file uses the factory method to create operations
"""
########################
# Operation Classes    #
########################
...
class Modulus(Operation):
    ...
    Calculates the remainder of two divided numbers.
    """
    def validate_operands(self, a: Decimal, b: Decimal) -> None:
        """
    ...
    def execute(self, a: Decimal, b: Decimal) -> Decimal:
        ...
        Returns:
            Decimal: Remainder left over from division.
        """
        self.validate_operands(a, b)
        return a % b
...
class IntDivision(Operation):
    ...
    Divides two numbers and rounds remainder down.
    """
    def validate_operands(self, a: Decimal, b: Decimal) -> None:
        """
        Validate operands, checking for int division by zero.
    ...
    def execute(self, a: Decimal, b: Decimal) -> None:
        """
        Divides two numbers and rounds down to the lowest whole number.
...
class Percentage(Operation):
    ...
    Divides two numbers and multiplies them by one hundred.
    """
    def validate_operands(self, a: Decimal, b: Decimal) -> None:
        """
        Validate operands, checking for division by zero.
    ...
    def execute(self, a: Decimal, b: Decimal) -> Decimal:
        """
        Divides two numbers and multiplies the quotient by 100.
...
class AbsoluteDifference:
    ...
    def execute(self, a: Decimal, b: Decimal) -> Decimal:
        """
        Finds the absolute value of two numbers subtracted from each other.
